              ...
              <Dialog>
                ...
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>Set up a new budget for a project or operational expense</DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-sm font-medium text-gray-600">Budget Name *</label>
                        <Input placeholder="Enter budget name" value={newBudget.name} onChange={(e) => setNewBudget({ ...newBudget, name: e.target.value })} />
                      </div>
                      <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input placeholder="Enter project name" value={newBudget.projectName} onChange={(e) => setNewBudget({ ...newBudget, projectName: e.target.value })} />
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-600">Total Budget *</label>
                        <Input type="number" placeholder="0" value={newBudget.totalBudget} onChange={(e) => setNewBudget({ ...newBudget, totalBudget: parseFloat(e.target.value) || 0 })} />
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-sm font-medium text-gray-600">Start Date *</label>
                        <Input type="date" value={newBudget.startDate} onChange={(e) => setNewBudget({ ...newBudget, startDate: e.target.value })} />
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-600">End Date *</label>
                        <Input type="date" value={newBudget.endDate} onChange={(e) => setNewBudget({ ...newBudget, endDate: e.target.value })} />
                      </div>
                    </div>
                    <div className="flex justify-end space-x-2">
                      <Button variant="outline">Cancel</Button>
                      <Button onClick={handleCreateBudget} disabled={!newBudget.name || !newBudget.projectName || !newBudget.totalBudget} className="bg-blue-600 hover:bg-blue-700">
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-purple-600">{stats.totalBudget > 0 ? Math.round((stats.totalSpent / stats.totalBudget) * 100) : 0}%</p>
                  </div>
            ...
            <div className="flex gap-4 items-center">
              <div className="flex-1">
                <div className="relative">
                  ...
                  <Input placeholder="Search budgets..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10" />
                </div>
              </div>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        {budget.alerts.length > 0 && (
                          <div className="space-y-1">
                            ...
                            {budget.alerts.length > 2 && <div className="text-xs text-gray-500">+{budget.alerts.length - 2} more alerts</div>}
                          </div>
                        )}
