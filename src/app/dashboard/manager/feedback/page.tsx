...
interface Feedback {
  ...
  projectName: string;
  rating: number;
  category: 'general' | 'quality' | 'communication' | 'timeline' | 'budget';
...
export default function ManagerFeedbackPage() {
  ...
  useEffect(() => {
    ...
    setFeedback([
      ...
      },
      {
        ...
        description: "The project is going well overall, but I would appreciate more frequent updates on progress. Sometimes I don't hear from the team for days.",
        submittedAt: "2024-10-14T14:20:00Z",
        lastUpdated: "2024-10-15T09:15:00Z",
        response: "Thank you for the feedback. We'll implement daily progress updates going forward.",
      ...
      },
      {
        ...
        clientEmail: "lisa.wang@business.com",
        ...
        response: "Thank you for your kind words! We're thrilled the project was successful.",
        responseBy: "Project Manager",
      ...
      },
      {
        ...
        description: "We're concerned about the additional costs that weren't in the original estimate. Can we discuss this further?",
        submittedAt: "2024-10-16T08:15:00Z",
        lastUpdated: "2024-10-16T08:15:00Z",
        tags: ["budget", "concern", "urgent"]
      },
      {
        id: "5",
        clientName: "Emma Thompson",
        clientEmail: "emma.thompson@home.com",
        ...
        description: "The living room looks absolutely beautiful. The team was professional, clean, and delivered exactly what we envisioned.",
        ...
        tags: ["living-room", "transformation", "positive"]
      }
    ]);
  }, []);
    ...
    const updatedFeedback = feedback.map(item => 
      item.id === feedbackId 
        ? { 
            ...
            responseBy: user?.name || "Project Manager",
  ...
  const handleStatusChange = (feedbackId: string, newStatus: string) => {
    const updatedFeedback = feedback.map(item => 
      item.id === feedbackId 
        ? { ...item, status: newStatus as any, lastUpdated: new Date().toISOString() }
        : item
    );
    setFeedback(updatedFeedback);
  };
    ...
    <SidebarProvider>
      ...
      <SidebarInset className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-blue-900/20 dark:to-indigo-900/20 min-h-screen">
        <DashboardHeader
          ...
          description="Manage and respond to client feedback and reviews"
          breadcrumbs={[
        ...
        <div className="flex-1 p-6 pt-0 space-y-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage and respond to client feedback and reviews</p>
            </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <Card className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-white/20 dark:border-gray-700/20 shadow-sm">
                  <CardHeader>
                    ...
                    <CardDescription>Distribution of client ratings</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-white/20 dark:border-gray-700/20 shadow-sm">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {['general', 'quality', 'communication', 'timeline', 'budget'].map((category) => {
